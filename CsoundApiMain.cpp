...
DLLExport unsigned long getNumBidules() { return 1; }

DLLExport ErrorCode fillBiduleInfo(unsigned long biduleIdx,
                                   BidulePluginInfo* biduleInfo) {
  ...
  switch (biduleIdx) {
    case 0:
      strcpy(biduleInfo->type, "com.acme.CsoundApi");
      strcpy(biduleInfo->name, "CsoundApi");
      strcpy(biduleInfo->fullName, "*rootsix\tplugins\tCsoundApi");
